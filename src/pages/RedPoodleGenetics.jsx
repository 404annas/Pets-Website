      ...
      <section className="py-10 px-6 max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2">
            ...
            <div className="bg-blue-50 p-6 rounded-2xl border-l-4 border-brand-pink-500">
      ...
      <section className="py-10 px-6 bg-gray-50 border-y border-gray-100">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 items-center">
          <div className="space-y-8">
            <div>
              <h2 className="text-transparent bg-gradient-to-r from-brand-pink-700 to-brand-blue-700 bg-clip-text fr text-3xl md:text-4xl font-black uppercase tracking-tighter mb-4">Why Red is Rare ?</h2>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-brand-pink-500">
                <Activity size={30} className="text-brand-pink-500 mb-4" />
          ...
          <div className="bg-white p-10 rounded-2xl border-2 border-brand-blue-500">
             ...
             <div className="flex gap-2">
                <div className="w-14 h-14 bg-brand-blue-700 rounded-full flex items-center justify-center text-white text-[10px] font-bold uppercase">Points</div>
      ...
      <section className="sticky bottom-0 bg-white/95 backdrop-blur-md border-t border-brand-blue-500/30 py-6 px-6 z-40">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex md:flex-row flex-col gap-2">
            <button onClick={() => navigate("/available")} className="bg-brand-pink-500 text-white px-8 py-3 rounded-full font-bold uppercase text-xs hover:bg-brand-pink-700 transition-colors cursor-pointer duration-300 shadow-sm shadow-brand-pink-700/20">
