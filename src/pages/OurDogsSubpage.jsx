    ...
    return (
        <div className="bg-white text-gray-700 leading-relaxed">
            ...
            <nav className="py-4 px-6 max-w-7xl mx-auto flex items-center gap-2 text-xs font-bold uppercase text-gray-400">
                <button onClick={() => navigate('/our-dogs')} className="hover:text-[#8ECC14] cursor-pointer">Our Dogs</button>
            ...
            <section className="py-10 px-6 max-w-7xl mx-auto">
                <div className="flex flex-col lg:flex-row gap-10 items-center">
                    <div className="lg:w-2/3">
                        ...
                        <p className="text-lg text-gray-800 font-medium leading-tight max-w-xl">
                            Why pedigree matters <span className="text-[#8ECC14]">more than most people realize.</span>
                        </p>
                    </div>
                    <div className="lg:w-1/3 bg-[#E2F1C4] px-4 py-6 md:p-8 rounded-[2.5rem] relative overflow-hidden">
                        <Network className="absolute -right-4 -bottom-4 text-[#8ECC14]/20" size={160} />
                        <p className="relative z-10 text-sm text-gray-800 italic">
            ...
            <section className="py-10 px-6 bg-[#F9FFF0] border-y border-gray-100">
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {[
                        ...
                        <div key={idx} className="group">
                            <div className="w-12 h-12 rounded-xl bg-white shadow-sm flex items-center justify-center text-[#8ECC14] mb-6 group-hover:bg-[#8ECC14] group-hover:text-white transition-all">
                                {item.icon}
                            </div>
                            <h3 className="font-bold uppercase text-base text-gray-900 mb-3">{item.t}</h3>
            ...
            <section className="py-10 px-6 max-w-7xl mx-auto">
                <div className="grid lg:grid-cols-2 gap-10 items-start">
                    <div>
                        <h2 className="text-[#8ECC14] text-3xl md:text-4xl font-black uppercase tracking-tighter mb-8">
                        ...
                        <div className="space-y-6 text-gray-600">
                            ...
                            <div className="px-4 py-6 border-l-4 border-[#8ECC14] bg-gray-50">
                    ...
                    <div className="space-y-4">
                        <div className="bg-white border border-gray-100 px-4 py-6 md:p-8 rounded-xl shadow-sm">
                            <h3 className="text-gray-900 font-bold uppercase text-lg md:text-xl mb-4">Breeding for Improvement</h3>
                            <ul className="space-y-4 text-sm text-gray-500">
                                <li className="flex items-start gap-3">
                                    <div className="w-5 h-5 rounded-full bg-[#E2F1C4] flex items-center justify-center shrink-0 mt-0.5"><div className="w-1.5 h-1.5 rounded-full bg-[#8ECC14] animate-pulse"></div></div>
                        ...
                        <div className="px-4 py-6 md:p-8 rounded-xl bg-[#8ECC14] text-white">
            ...
            <section className="py-10 px-6 bg-gray-50">
                <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center">
                    <div>
                        <h2 className="text-gray-900 text-3xl md:text-4xl font-black uppercase mb-6">Titles in Context</h2>
                        <p className="text-gray-600 mb-6">
                            Some dogs carry recognitions, but they are only part of the picture. We look at the full story:
                        </p>
                        <div className="flex flex-col gap-3">
                            <div className="bg-white p-4 rounded-xl border border-gray-100 flex justify-between items-center group cursor-default">
                                <span className="text-xs font-bold uppercase text-gray-400">Accomplished Foundation</span>
                                <span className="text-[#8ECC14] font-bold">Health First</span>
                            </div>
                            <div className="bg-white p-4 rounded-xl border border-gray-100 flex justify-between items-center group cursor-default">
                                <span className="text-xs font-bold uppercase text-gray-400">Breed Standards</span>
                                <span className="text-[#8ECC14] font-bold">Temperament Always</span>
                            </div>
                        </div>
                    </div>
                    <div className="bg-white px-6 py-8 md:p-10 rounded-2xl border-2 border-[#E2F1C4] relative">
                        <h3 className="text-[#8ECC14] font-bold uppercase text-lg md:text-xl mb-4">Ethics over Trends</h3>
            ...
            <section className="py-10 px-6">
                <div className="max-w-4xl mx-auto bg-gray-900 rounded-[3rem] p-10 md:p-16 text-center text-white relative overflow-hidden">
                    <div className="absolute top-0 left-0 w-32 h-32 bg-[#8ECC14]/20 blur-[60px]"></div>

                    <h2 className="text-3xl sm:text-4xl md:text-5xl font-black uppercase tracking-tighter mb-8 relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4 relative z-10">
                        <button
                            ...
                            className="bg-[#8ECC14] text-white px-8 py-4 rounded-full font-bold uppercase tracking-wide text-xs hover:scale-105 transition-all duration-300 cursor-pointer"
                        >
                            Meet Our Dogs
                        </button>
                        <button
                            onClick={() => navigate('/#contact')}
                            className="bg-white text-gray-900 px-8 py-4 rounded-full font-bold uppercase tracking-wide text-xs hover:bg-[#C6E589] transition-all duration-300 cursor-pointer flex items-center justify-center gap-2"
                        >
                            <MessageSquare size={16} /> Ask About Pedigrees
                        </button>
                    </div>

                    <p className="mt-12 text-gray-300 text-xs uppercase tracking-widest font-bold">
