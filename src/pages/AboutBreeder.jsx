...
const AboutBreeder = () => {
    ...
    return (
        <div className="bg-white text-gray-700 leading-relaxed overflow-x-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="flex flex-col lg:flex-row items-start gap-10">
                        ...
                        <div className="w-full lg:w-3/5">
                            <div className="inline-block px-4 py-1 bg-[#8db935] text-white text-xs font-bold uppercase tracking-[0.3em] mb-6">
                                Established with Love
                            </div>

                            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-gray-800 leading-none mb-8 uppercase">
                                About the <br />
                                <span className="text-[#8ECC14]">Breeder</span>
                            </h1>

                            <div className="max-w-xl">
                                <h2 className="text-base sm:text-lg md:text-xl font-bold text-gray-800 mb-6 border-l-4 border-[#8ECC14] pl-6 uppercase tracking-tight">
                                    Who we are — <span className="text-[#8ECC14]">Passionate people, playful poodles</span>
                                </h2>
                                ...
                                <div className="space-y-4 text-gray-500 text-base leading-relaxed italic">
                                    ...
                                    <p className="not-italic font-semibold text-gray-700 text-lg">
                                        That’s who we are!
                                    </p>
                                    <p>
                        ...
                        <div className="w-full lg:w-2/5 relative">
                            ...
                            <div className="absolute -bottom-6 -right-6 w-full h-full border-[12px] border-[#C6E589] z-0 rounded-2xl" />
                            ...
                            <div className="relative z-10 rounded-2xl overflow-hidden shadow-sm">
                                ...
                                <div className="absolute bottom-0 left-0 right-0 bg-white/90 backdrop-blur-sm p-4">
                                    <p className="text-xs uppercase tracking-widest text-[#8ECC14] font-bold">
            ...
            <section className="bg-[#E2F1C4] py-10 px-6 overflow-hidden">
                <div className="max-w-7xl mx-auto">

                    {/* Header with Background Text Effect */}
                    <div className="relative mb-10 text-center lg:text-left">
                        <span className="absolute -top-10 left-0 text-white text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-black opacity-40 select-none hidden lg:block">
                            ORIGIN
                        </span>
                        <h2 className="relative z-10 text-[#8ECC14] text-4xl md:text-5xl font-black uppercase tracking-tight">
                    ...
                    <div className="grid lg:grid-cols-12 gap-10 items-start">
                        ...
                        <div className="lg:col-span-5 relative group">
                            <div className="absolute inset-0 bg-[#C6E589] rounded-3xl translate-x-3 translate-y-3"></div>
                            <div className="relative bg-white px-6 py-8 sm:p-8 md:p-12 rounded-3xl shadow-sm border border-[#C6E589]/30">
                                <p className="text-[#C6E589] font-semibold mb-4 tracking-widest uppercase text-xs">Phase 01</p>
                                <p className="text-2xl font-medium text-gray-800 leading-snug mb-6">
                                    This did not begin with a plan to <span className="text-[#8ECC14]">“become breeders.”</span>
                                </p>
                        ...
                        <div className="lg:col-span-7 space-y-12 lg:pl-12">
                            <div className="max-w-xl">
                                <h3 className="text-[#8ECC14] font-bold text-xl md:text-2xl mb-4">The Curiosity Phase</h3>
                                ...
                                <div className="mt-6 flex gap-4">
                                    <div className="h-[1px] w-12 bg-[#C6E589] self-center"></div>
                                    <p className="italic text-[#8ECC14] text-sm">Late nights reading pedigrees & studying health testing</p>
                                </div>
                            </div>

                            {/* The "2 AM" Highlight Block */}
                            <div className="bg-white/60 backdrop-blur-md px-4 py-6 md:p-8 rounded-2xl border-l-8 border-[#8ECC14] shadow-sm">
                                <h3 className="text-gray-800 font-bold text-xl mb-4 uppercase tracking-tighter">The Real Lessons</h3>
                                <p className="text-gray-700 leading-loose italic">
                                    "Then came the lessons you don’t get from books.
                                    <span className="text-[#8ECC14] font-bold not-italic px-1 underline decoration-[#C6E589]">Weighing newborns at 2 a.m.</span>
                                    Holding our breath during first feedings. Learning to tell the difference
                                    between a tired squeak and a hungry cry."
                                </p>
                                <div className="mt-8 grid grid-cols-3 gap-2">
                                    <div className="h-1 bg-[#8ECC14]"></div>
                                    <div className="h-1 bg-[#C6E589]"></div>
                            ...
                            <div className="max-w-xl">
                                <p className="text-gray-600 text-sm md:text-base leading-relaxed">
                                    ...
                                    <span className="block mt-4 text-[#8ECC14] font-bold text-xl md:text-2xl uppercase tracking-tighter">
            ...
            <section className="py-10 px-6 max-w-7xl mx-auto">
                <div className="text-center mb-10">
                    <h2 className="text-gray-900 text-4xl md:text-5xl font-black leading-none mb-6">
                        What we <br />
                        <span className="text-[#8ECC14] underline decoration-[#C6E589] decoration-8 underline-offset-8">Believe</span>
                    </h2>
                ...
                <div className="flex flex-wrap justify-center gap-4">
                    {beliefs.map((item, idx) => (
                        <div
                            key={idx}
                            className={`${item.bg} border border-[#C6E589] px-6 py-8 md:p-10 rounded-[2.5rem] shadow-sm hover:shadow-md hover:-translate-y-2 transition-all duration-500 group relative overflow-hidden w-full md:w-[calc(48%-1.5rem)] lg:w-[calc(33.33%-1.5rem)]`}
                        >
                            <span className="absolute -right-4 -bottom-8 text-9xl font-black text-gray-100/50 group-hover:text-[#C6E589]/20 transition-colors pointer-events-none">
                                {idx + 1}
                            </span>
                            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-white shadow-sm mb-8 text-[#8ECC14] group-hover:bg-[#8ECC14] group-hover:text-white transition-all duration-500">
                                {item.icon}
                            </div>
                            <h3 className="text-xl font-bold text-gray-800 mb-4 relative z-10">{item.t}</h3>
                            <p className="text-gray-500 leading-relaxed relative z-10">{item.d}</p>
                            <div className="absolute bottom-0 left-0 h-1 bg-[#8ECC14] w-0 group-hover:w-full transition-all duration-700"></div>
                        </div>
                    ))}

                    {/* Full Width Quote Card */}
                    <div className="max-w-6xl mt-6 bg-gray-900 p-10 rounded-[2.5rem] flex flex-col md:flex-row items-center justify-between gap-8">
                        ...
                        <p className="text-[#8ECC14] font-bold uppercase tracking-widest text-sm shrink-0">
                            Our Core Promise
                        </p>
                    </div>
                </div>
            ...
            <section className="bg-white py-10 px-8 border-gray-100">
                <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-16 items-center">
                    ...
                    <div className="flex-1">
                        <h2 className="text-[#8ECC14] text-2xl md:text-3xl font-bold mb-6">How we learned to do this properly ?</h2>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-600">
                            <p className="bg-[#E2F1C4] p-3 rounded flex items-center gap-2"><Languages size={20} />Reading puppy body language</p>
                            <p className="bg-[#E2F1C4] p-3 rounded flex items-center gap-2"><Ban size={20} /> When NOT to breed</p>
                            <p className="bg-[#E2F1C4] p-3 rounded flex items-center gap-2"><ShieldCheck size={20} /> Patience protects the breed</p>
                            <p className="bg-[#E2F1C4] p-3 rounded flex items-center gap-2"><Blocks size={20} /> Integrity outlasts trends</p>
                        </div>
                        <p className="mt-8 italic text-gray-600">"Breeding is a community effort. Pretending otherwise is how breeds get damaged."</p>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col lg:flex-row items-stretch gap-0">
                        ...
                        <div className="lg:w-5/12 pb-10 lg:pb-0 lg:pr-10 flex flex-col justify-center">
                            <span className="text-[#C6E589] font-semibold tracking-widest uppercase text-xs mb-6 block">
                                Direct Connection
                            </span>
                            <h2 className="text-gray-900 text-3xl sm:text-4xl md:text-5xl font-black leading-[0.9] mb-10 tracking-tighter">
                                Who is actually <br />
                                <span className="text-[#8ECC14]">raising your puppy</span>
                            </h2>
                            ...
                            <div className="space-y-6 text-gray-500 text-base md:text-lg max-w-md">
                                <p>
                                    ...
                                    <span className="text-[#8ECC14] font-bold px-1 underline decoration-[#C6E589] decoration-4">
                            ...
                            <div className="mt-10 space-y-4">
                                {["Weigh the puppies", "Clean the whelping area", "First grooming session", "Sit on the floor during playtime"].map((item, idx) => (
                                    <div key={idx} className="flex items-center gap-4 group cursor-default">
                                        <div className="w-8 h-[1px] bg-[#C6E589] group-hover:w-12 transition-all duration-300"></div>
                                        <span className="uppercase text-xs font-bold tracking-widest text-gray-400 group-hover:text-[#8ECC14] transition-colors">
                                            {item}
                                        </span>
                                    </div>
                                ))}
                        ...
                        <div className="lg:w-7/12 lg:pl-16 pt-12 lg:pt-0 flex flex-col">
                            <div className="relative">
                                ...
                                <div className="absolute -bottom-10 -left-10 bg-[#E2F1C4] p-8 md:p-12 max-w-sm shadow-sm hidden md:block">
                                    ...
                                    <p className="mt-6 text-xs font-black uppercase tracking-widest text-[#8ECC14]">
                                        The details matter.
                                    </p>
                                </div>
                            </div>
            ...
            <section className="py-10 px-8 text-center max-w-5xl mx-auto">
                <h2 className="text-[#C6E589] uppercase tracking-widest text-xs font-bold mb-6">Looking Ahead</h2>
                <h3 className="text-3xl sm:text-4xl md:text-5xl font-bold uppercase tracking-tight text-gray-900 mb-8">By <span className="text-[#8ECC14]">2028,</span> our goal is not to be <span className="text-[#8ECC14]">bigger.</span> It’s to be <span className="text-[#8ECC14]">better.</span></h3>
                <p className="text-base md:text-lg text-gray-500 italic mb-12">
                    "If this ever stops being about love for the dogs, we’ll stop. That’s the promise."
                </p>
                <div className="flex flex-wrap justify-center gap-8 text-gray-800 font-medium">
            ...
            <section className="py-10 bg-white overflow-hidden">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-baseline mb-10 gap-6">
                        <div className="relative">
                            <span className="text-[#C6E589] font-black text-4xl md:text-5xl lg:text-6xl opacity-20 absolute -top-8 -left-4 select-none">
                                CANDID
                            </span>
                            <h2 className="text-[#8ECC14] text-3xl sm:text-4xl md:text-5xl font-black uppercase tracking-tighter relative z-10">
                            ...
                            >
                                ...
                                <div className="relative h-[500px] w-full mb-6 overflow-hidden rounded-2xl">
                                    ...
                                    <div className="absolute top-6 left-6 bg-white/90 backdrop-blur-md w-12 h-12 rounded-full flex items-center justify-center shadow-sm">
                                        <span className="text-[#8ECC14] font-black text-xs">{item.id}</span>
                                    </div>

                                    {/* Glassmorphism Bottom Overlay */}
                                    <div className="absolute bottom-0 left-0 right-0 p-8 translate-y-full group-hover:translate-y-0 transition-transform duration-500 bg-gradient-to-t from-[#8ECC14]/90 to-transparent backdrop-blur-sm">
                                ...
                                <div className="px-2">
                                    <div className="flex items-center gap-4 mb-1">
                                        <div className="h-[2px] w-8 bg-[#C6E589]"></div>
                                        <h3 className="text-[#8ECC14] font-black text-xl uppercase tracking-tighter">
                                            {item.title}
                                        </h3>
                                    </div>
                    ...
                    <div className="flex justify-center mt-4">
                        <div className="w-48 h-1 bg-gray-100 rounded-full overflow-hidden">
                            <div className="w-1/3 h-full bg-[#C6E589] rounded-full"></div>
                        </div>
                    </div>
                </div>
