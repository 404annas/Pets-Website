        ...
        <div className="bg-white text-gray-700 leading-relaxed">
            ...
            <section className="bg-white pt-10 pb-5 px-6">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-end justify-between gap-6">
                    <div className="max-w-2xl">
                        ...
                        <p className="text-brand-blue-700 font-bold uppercase tracking-wide text-sm md:text-base">
                            & Formal Contractual Agreement
                        </p>
                    </div>
                    <div className="md:text-right">
                        <p className="text-gray-800 text-xl font-bold mb-2">"Because Puppies Are Loved, <span className='text-brand-pink-500'>Not Sold</span>"</p>
            ...
            <section className="py-10 px-6">
                <div className="max-w-7xl mx-auto">
                    <div className="bg-blue-50 px-y py-8 md:p-12 rounded-2xl flex flex-col lg:flex-row gap-10 items-center">
            ...
            <section className="py-10 px-6 bg-white">
                <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-4">
                    ...
                    {/* What is Included */}
                    <div className="bg-brand-blue-500/5 border border-brand-blue-500 px-6 py-8 md:p-12 rounded-2xl">
                        ...
                        <ul className="space-y-6">
                            {covered.map((text, i) => (
                                <li key={i} className="flex gap-4 items-center text-brand-blue-500">
                                    <span>{text.icon}</span>
                                    {text.text}
                                </li>
                            ))}
                    ...
                    {/* What is Not Covered */}
                    <div className="bg-brand-pink-500/5 border border-brand-pink-500 p-8 md:p-12 rounded-2xl">
                        <div className="flex items-center gap-4 mb-8">
            ...
            <section className="py-10 px-6 max-w-7xl mx-auto">
                ...
                <div className="grid md:grid-cols-3 gap-0 border border-brand-blue-500">
                    {[
                        ...
                        <div key={idx} className="p-8 border-r border-brand-blue-500 last:border-r-0 hover:bg-blue-50 transition-colors duration-300">
            ...
            <section className="relative py-10 px-6 bg-blue-50 overflow-hidden">
                    ...
                    <div className="flex flex-col lg:flex-row justify-between items-end mb-16 gap-8">
                        <div className="max-w-2xl">
                            <div className="flex items-center gap-2 mb-4">
                                ...
                                <span className="text-brand-pink-700 font-bold tracking-[0.2em] text-xs uppercase">Guaranteed Protection</span>
                            </div>
                            <h2 className="text-4xl sm:text-5xl md:text-6xl fr font-black uppercase tracking-tighter leading-[0.9] text-gray-900">
                                Full Contract <br />
                                <span className="text-transparent" style={{ WebkitTextStroke: '1px var(text-transparent bg-gradient-to-r from-brand-pink-700 to-brand-blue-700 bg-clip-text)' }}>Included With</span> <br />
                                <span className='text-transparent bg-gradient-to-r from-brand-pink-700 to-brand-blue-700 bg-clip-text'>Every Puppy</span>
                            </h2>
                        </div>
                        <div className="lg:mb-2">
                            <p className="text-gray-700 max-w-sm text-base leading-relaxed border-l-2 border-brand-pink-700 pl-6">
            ...
            <section className="py-10 px-6">
                <div className="max-w-3xl mx-auto text-center">
                    <h2 className="text-5xl font-black uppercase text-transparent bg-gradient-to-r from-brand-pink-700 to-brand-blue-700 bg-clip-text fr mb-6">Communication is Key</h2>
                    ...
                    <p className="mt-10 text-brand-pink-700 text-xs uppercase tracking-widest font-bold">
