    ...
    return (
        <nav className="w-full flex items-center justify-between px-8 py-4 bg-white border-b border-pink-100">
            ...
            <div className="flex-1 flex justify-start items-center">
                <Link to={"/"} className='text-4xl font-bold font-serif cursor-pointer bg-gradient-to-r from-pink-500 to-blue-500 bg-clip-text text-transparent uppercase tracking-tight'>USA Poodle</Link>
            </div>
